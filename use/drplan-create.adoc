...
* *Compute resources*
* *Virtual networks*
* *Virtual machines*: Under the Virtual machines details, you can optionally resize the VM CPU and RAM parameters.
+
