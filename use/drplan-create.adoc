...
+
image:dr-plan-create-apps-vms3.png[Screenshot showing the Add replication plan > Applications to replicate page]
...
+
image:dr-plan-resource-mapping.png[Replication plan, Resource mapping tab]
