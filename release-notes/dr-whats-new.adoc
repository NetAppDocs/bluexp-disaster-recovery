...
+
Refer to link:../use/dashboard-view.html[View the health of your disaster recovery plans on the Dashboard].
...
** *Edit schedules*: You can now update the replication plan schedules. 
+
Refer to link:../use/manage.html[Manage resources].
