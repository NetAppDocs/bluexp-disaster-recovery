...
* *Licensing updates*: With this release, you can sign up for a 90-day free trial or use a Bring Your Own License (BYOL). BlueXP disaster recovery charges are based on provisioned capacity of datastores. 
