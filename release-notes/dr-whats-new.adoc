...
You can add a replication plan more easily by filtering VMs by datastore on the Applications page and by selecti//Refer to link:../use/drplan-create.html[Create a replication plan].
