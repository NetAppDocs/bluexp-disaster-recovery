...
* *Replicating VMware workloads from on-premises to on-premises* is now released as a general availability feature. Previously, it was a tech preview with limited functionality
