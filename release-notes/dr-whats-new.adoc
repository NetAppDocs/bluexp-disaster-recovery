...
* *Licensing updates*: With this release, BlueXP disaster recovery charges are based on provisioned capacity of datastores. 

+
For details about setting up licensing for BlueXP disaster recovery, *TBD*. For details about managing licenses for all BlueXP services, refer to https://docs.netapp.com/us-en/bluexp-digital-wallet/task-manage-data-services-licenses.html[Manage BlueXP licenses].
...
* With this release, you can click several links in the Dashboard to access information quickly. 
