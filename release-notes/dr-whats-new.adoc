...
* *Custom scripts* can now be included as pre and post failover processes. With custom scripts, you can have BlueXP disaster recovery run your script before and after a failover process. For example, you can use a custom script to pause all database transactions before a failover and resume transactions after the failover is complete.  
+
