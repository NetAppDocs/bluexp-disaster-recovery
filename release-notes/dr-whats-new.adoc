...
Now with BlueXP disaster recovery, you can protect (against disasters) your on-premises, NFS-based VMware workloads to another on-premises, NFS-based VMware environment. BlueXP disaster recovery addresses the full orchestration of disaster recovery plans and completion.  
