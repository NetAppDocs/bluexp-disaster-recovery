...
. From BlueXP disaster recovery, select *Sites*, select the vCenter, select the *Actions* menu, and from the Actions menu, select *Refresh* to refresh the FSx discovery in BlueXP disaster recovery. 
+
