...
The BlueXP disaster recovery service can be used either with a NetApp license or an annual subscription-based plan through Amazon Web Services. In the marketplace, subscribe to "NetApp Intelligent Services".
