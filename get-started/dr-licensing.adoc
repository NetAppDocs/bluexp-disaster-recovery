...
There are two parts to set up a PAYGO license in AWS: 

* <<Part 1 Configure a PAYGO license in AWS>>
* <<Part 2 Associate the new SaaS Marketplace subscription with AWS credentials>> or 
+
<<Part 2 Associate the new SaaS Marketplace subscription with AWS credentials for annual contracts>>.
...
** <<Part 2 Associate the new SaaS Marketplace subscription with AWS credentials>>
** <<Part 2 Associate the new SaaS Marketplace subscription with AWS credentials for annual contracts>>.

=== Part 2 Associate the new SaaS Marketplace subscription with AWS credentials

This Part 2 of setting up a license in AWS. 

NOTE: If you have an annual contract, continue with Part 2 here: 
<<Part 2 Associate the new SaaS Marketplace subscription with AWS credentials for annual contracts>>.
