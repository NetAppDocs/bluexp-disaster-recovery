...
After the free trial ends, you can either purchase a license from NetApp or subscribe to *NetApp Intelligent Services* through AWS Marketplace or Microsoft Azure Marketplace. This procedure provides a high level overview of how to subscribe directly in one of the Marketplaces. 
...
+
Or, from the top right, select *View payment methods*. 
+
image:dr-licensing-payment-methods.png[The BlueXP disaster recovery Payment methods page]

. Select *Subscribe in AWS Marketplace* or *Subscribe in Azure Marketplace*. 
. Use AWS Marketplace or Microsoft Azure Marketplaceto subscribe to *NetApp Intelligent Services* and *BlueXP disaster recovery*. 
